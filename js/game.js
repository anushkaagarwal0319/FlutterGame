class Game{
    ...
    play(){
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if (frameCount % 100 === 0) {
                    bees = createSprite(random(100, 1000), 0, 100, 100);
                    bees.velocityY = 6;
                    bees.addImage("bee", bee_img);
                  ...
                  if (player.index !== null) {
                      ...
                      for (var i = 0; i < beeGroup.length; i++) {
                        if (beeGroup.get(i).isTouching(players)) {
                            beeGroup.get(i).destroy();
       ...
       gameover.addImage("gameover", game_img)
